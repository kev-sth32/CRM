...
(async () => {
  ...
  console.log('âœ“ 1. Security headers & health checks verified');
  ...
  console.log('âœ“ 2. Unauthenticated request rejection (401 Unauthorized) verified');
  ...
  console.log('âœ“ 3. Cryptographic password verification (Bad credentials rejected) verified');
  ...
  console.log('âœ“ 4. Successful authenticated login & cookie issuance verified');
  ...
  console.log(`âœ“ 5. Authenticated CRM queries succeed with active session (${leads.length} leads returned)`);
  ...
  console.log('âœ“ 6. RBAC Superadmin role enforcement (403 Forbidden) verified');
  ...
  console.log('âœ“ 7. Superadmin authentication and platform telemetry verified');
  ...
  if (leads.length > 0) {
    ...
    console.log('âœ“ 8. Transactional email engine & timeline activity logging verified');
  }
  ...
  console.log('âœ“ 9. SaaS Subscription & Stripe checkout session integration verified');
  ...
  console.log('âœ“ 10. Sliding window brute-force rate limiter (429 Too Many Requests) verified');
  ...
  console.log('âœ“ 11. Public customer proposal access without authentication verified');
  ...
  const rRegister = await fetch(`${base}/api/auth/register`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json', 'x-test-bypass': (process.env.TEST_BYPASS_SECRET || 'salesos-internal-test') },
    body: JSON.stringify({
  ...
  console.log('âœ“ 12. Self-serve workspace registration & automatic tenant provisioning verified');
  ...
  console.log('âœ“ 13. Strict column name sanitization & SQL injection defense verified');
  ...
  console.log('âœ“ 14. Anti-IDOR 48-char high-entropy access token & token-based public resolution verified');
  ...
  console.log('âœ“ 15. ESIGN Act non-repudiation audit bundle (SHA-256, IP, User-Agent, Certificate) verified');
  ...
  console.log('âœ“ 16. Automated self-serve password reset workflow & session invalidation verified');
  ...
  console.log('âœ“ 17. GDPR Article 20 full workspace data portability archive verified');
  ...
  console.log('âœ“ 18. Static asset sandboxing & P0 database/source file read defense verified');
  ...
  console.log('âœ“ 19. Outbound SSRF defense (Cloud metadata, loopback, private subnets) verified');
  ...
  console.log('âœ“ 20. Insecure CORS credential reflection defense verified');
  ...
  console.log('âœ“ 21. GDPR Article 17 Right to Erasure (Permanent PII Scrub & Legal Certificate) verified');
  ...
  console.log('âœ“ 22. CAN-SPAM & RFC 8058 one-click automated unsubscribe flow verified');
  ...
  try {
    ...
    console.log('âœ“ 23. Payload size limit & CWE-400 memory exhaustion defense (HTTP 413) verified');
  } catch (err) {
  ...
  console.log('âœ“ 24. EventStream (SSE) authentication & tenant protection verified');
  ...
  console.log('âœ“ 25. ESIGN Act contract immutability & non-repudiation defense (409 Conflict) verified');
  ...
  console.log('âœ“ 26. AI tool approval authorization, state gates & execution idempotency verified');
  ...
  console.log('âœ“ 27. Stripe webhook anti-replay defense (300s timestamp drift tolerance) verified');
  ...
  console.log('âœ“ 28. Cryptographic hash buffer length safety & RangeError crash defense verified');
  ...
  console.log('âœ“ 29. Stored Cross-Site Scripting (XSS) payload escaping verified');
  ...
  console.log('âœ“ 30. Outbound email sender domain anti-spoofing & anti-relay defense verified');
  ...
  console.log('âœ“ 31. Memory session credential stripping & DLP protection (/api/auth/me) verified');
  ...
  console.log('âœ“ 32. Audit log secret redaction & credential masking verified');
  ...
  console.log('âœ“ 33. Outbound webhook secret masking in settings directory verified');
  ...
  console.log('âœ“ 34. Stored XSS defense in inbox, superadmin, and AI approvals views verified');

  // 35. Verify Password Reset Host Header Injection Defense
  const rPoisoned = await fetch(`${base}/api/auth/forgot-password`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json', 'Host': 'attacker-phishing-portal.com', 'x-test-bypass': (process.env.TEST_BYPASS_SECRET || 'salesos-internal-test') },
    body: JSON.stringify({ email: testRegEmail })
  });
  ...
  console.log('âœ“ 35. Password reset Host-header poisoning defense verified');
  ...
  console.log('âœ“ 36. AI Service strict policy enforcement on empty allowed_tools array verified');
  ...
  console.log('âœ“ 37. CORS host-header reflection & arbitrary origin spoofing defense verified');
  ...
  console.log('âœ“ 38. Content-Security-Policy & Permissions-Policy headers verified');
  ...
  console.log('âœ“ 39. Anti-IDOR defense for sequential quote IDs (401 Unauthorized) verified');
  ...
  console.log('âœ“ 40. Quote BOLA & Signed quote contract immutability verified');
  ...
  console.log('âœ“ 41. Mass assignment tenant reassignment defense verified');
  ...
  console.log('âœ“ 42. Dedicated self-serve registration rate limiter (429) verified');
  ...
  console.log('âœ“ 43. Cryptographic HMAC token enforcement on unsubscribe (403 Forbidden) verified');
  ...
  console.log('âœ“ 44. Per-tenant workspace settings partitioning and isolation verified');
  ...
  console.log('âœ“ 45. Omnichannel messages cross-tenant leakage & injection defense verified');
  ...
  console.log('âœ“ 46. Workspace data export RBAC enforcement (403 Forbidden for non-admins) verified');
  ...
  console.log('âœ“ 47. Custom field & webhook deletion cross-tenant BOLA defense verified');
  ...
  console.log('âœ“ 48. AI approval cross-tenant patch & state tampering rejection verified');
  ...
  console.log('âœ“ 49. CSV formula injection defense (CWE-1236) in reports.html verified');
  ...
  console.log('âœ“ 50. Custom field entity whitelist validation (400 Bad Request on invalid entity) verified');
  ...
  console.log('âœ“ 51. Inbound webchat webhook dynamic tenant resolution & message tagging verified');
  ...
  console.log('âœ“ 52. Cross-tenant sequence enrollment isolation in followup-service verified');

  console.log('\n======================================================');
  console.log('ðŸŽ‰ ALL 52 SECURITY & PRODUCTION READINESS CHECKS PASSED!');
  console.log('======================================================');
})().catch(err => {
  console.error('\nâŒ Security Test Suite Failed:', err);
  process.exit(1);
});
